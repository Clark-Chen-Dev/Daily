                    ...
                    <td height="30" valign="top" class="henhong"><table width="332" height="40" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td valign="top">用户名：     
                          ...
                          <br />
                            <asp:Label ID="Label1" runat="server" ForeColor="#FF0066" Text="请输入登陆昵称,如mr"></asp:Label>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="请输入登陆昵称,如mr" ControlToValidate="txtUserName"></asp:RequiredFieldValidator>
                      </tr>
                    </table>
                      <table width="332" height="40" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top">密 &nbsp;&nbsp;码：
                            ...
                            <br />
                              <asp:Label ID="Label2" runat="server" Text="请输入登陆密码如mrsoft"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                              ErrorMessage="请输入登陆密码如mrsoft" ControlToValidate="txtPassword"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                      </table>
                      <table width="332" height="40" border="0" cellpadding="0" cellspacing="0">
