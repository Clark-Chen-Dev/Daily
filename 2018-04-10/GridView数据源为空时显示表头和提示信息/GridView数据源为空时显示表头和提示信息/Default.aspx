<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GridView数据源为空时显示表头和提示信息.Default" %>
...
<head runat="server">
    ...
    <title>GridView数据源为空时显示表头和提示信息</title>
</head>
<body>
    <form id="form1" runat="server">
        <br />
        请输入查找商品的关键字：<asp:TextBox ID="tbSearch" runat="server"></asp:TextBox>
